...
sent = '물론 두 기업과 최순실 씨와 연결고리가 나온 건 아니지만, 정 전 비서관 녹취파일 속 최 씨는 외촉법에 상당히 집착을 하는 걸로 보이긴 합니다.'
taggers = [komoran, kkma, twitter, mecab]
names = 'komoran kkma twitter mecab'.split()
for tagger in taggers:
    pos = tagger.inst.pos(sent)
    print(str(pos))
