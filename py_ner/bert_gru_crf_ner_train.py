...
from py_ner.model.net import KobertCRF, KobertBiGRUCRF
...
class BertGruCrfTrainer(BertCrfTrainer):
    ...
    def train(self):
        # Model
        model = KobertBiGRUCRF(config=self.model_config, num_classes=len(self.tr_ds.ner_to_index))
        model.train()
...
if __name__ == '__main__':
    ...
    trainer = BertGluCrfTrainer(data_dir=data, model_dir=model_dir)
